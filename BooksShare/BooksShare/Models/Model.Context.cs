...
namespace BooksShare.Models
{
    ...
    public partial class bookshareEntities : DbContext
    {
        public bookshareEntities()
            : base("name=bookshareEntities")
        {
        }
        ...
        public virtual DbSet<Exchange_Information> Exchange_Information { get; set; }
